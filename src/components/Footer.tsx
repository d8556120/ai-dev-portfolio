      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-3 text-gray-400 text-sm leading-relaxed">
              Building AI-powered solutions that ship fast and scale.
              Turning complex requirements into production-ready software.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-indigo-400 transition-colors text-sm inline-flex items-center gap-2"
                >
        ...
        <div className="mt-10 pt-8 border-t border-white/5 text-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} DevAI. Built with Next.js & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
